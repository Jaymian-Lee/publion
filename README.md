...
De huidige release is **1.9.41**. Download het WordPress-importpakket: [publion-wordpress-1.9.41.zip](publion-wordpress-1.9.41.zip). Het pakket bevat precies één hoofdmap: `publion/`. Dat is de vereiste WordPress-structuur en voorkomt dat WordPress een tweede, losstaande pluginmap maakt.
...
1. Download [publion-wordpress-1.9.41.zip](publion-wordpress-1.9.41.zip).
