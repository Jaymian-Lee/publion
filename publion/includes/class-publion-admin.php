        ...
        wp_localize_script(
            ...
            [
                ...
                'i18n'        => [
                    ...
                    'unknown_topic'               => __( 'Een geselecteerd onderwerp', 'publion' ),
                    'queue_item_incomplete'       => __( 'Een geselecteerd onderwerp mist verplichte gegevens. Verwijder het onderwerp en voeg de voorstelkaart opnieuw toe.', 'publion' ),
                    ...
                    'create_now_confirm'          => __( 'Wil je nu een blogpost maken voor dit onderwerp? De knop toont de echte stappen op de server.', 'publion' ),
                    ...
                    'cancel_creation_confirm'     => __( 'Wil je de artikelgeneratie annuleren? Publion stopt bij het eerstvolgende veilige servermoment.', 'publion' ),
                    'cancel_requested'            => __( 'Annulering aangevraagd', 'publion' ),
                    'cancel_pending'              => __( 'De server stopt bij het eerstvolgende veilige moment.', 'publion' ),
                    'cancel_failed'               => __( 'Annuleren is niet gelukt. De artikelgeneratie kan nog actief zijn.', 'publion' ),
                    'cancel_connection_lost'      => __( 'Annuleren kon niet worden bevestigd. Ververs de wachtrij om de actuele status te controleren.', 'publion' ),
                    ...
                    'dismiss_message'             => __( 'Melding sluiten', 'publion' ),
