...
def header_footer(canvas, doc):
    ...
    canvas.drawRightString(width - 20 * mm, 10 * mm, f"Versie 1.9.38  |  Pagina {doc.page}")
    canvas.restoreState()
...
def build_story():
    ...
    story += [bullet("Ga naar Publion > OpenAI/ChatGPT instellingen en sla je API-sleutel op."),
              ...
              bullet("Open eerst de aparte tab Categorie-strategie om vijf passende hoofd- en subcategorieën te onderzoeken. Kies een doel, beoordeel elk volledig voorstel en maak afzonderlijk of in één bevestigde, veilige hiërarchische volgorde aan."),
    ...
    story += [p("Wat je in het dashboard ziet", "h2"), info_table([
        ...
        ("Categorie-strategie", "Handmatig onderzoek, review en veilige aanmaak van SEO- en GEO-geschikte hoofd- en subcategorieën."),
        ("Content plannen", "Categorie kiezen, AI-voorstellen, focus-keyword, zoekintentie, unieke invalshoek en FAQ-vragen."),
        ("Postcreatie", "Wachtrij, planning, direct maken, voortgang en gemaakte concepten."),
        ("Instellingen", "Duidelijke blokken voor automatische postcreatie, onderwerpen en categorieën, bronnen, SEO en opvolging."),
    ...
    story += [p("Planning instellen", "h2"), p("Onder Instellingen voor postcreatie staat Automatische postcreatie bovenaan. Kies Dagelijks voor één of meerdere posts per dag, of Elke X dagen voor een rustig ritme met één post per cyclus. Bij een dagelijks ritme kies je 1, 2, 3, 4, 6 of 8 posts per dag, een eerste aanmaaktijd en de uren waarover Publion de slots spreidt. Voorbeeld: drie posts vanaf 09:00, gespreid over acht uur, krijgen slots rond 09:00, 13:00 en 17:00."), note("Veilige verwerking", "Ook wanneer je meerdere posts per dag plant, verwerkt Publion steeds één artikel tegelijk. Zo blijven lange AI-taken, kosten en wachtrijstatus beheersbaar en worden dubbele creaties voorkomen. Verander je de planning, dan herplant Publion alleen de nog niet vastgezette wachtrij-items.", GREEN), p("Categorieën bewust apart", "h2"), p("In hetzelfde instellingenblok verwijst Categorieën maken direct naar de aparte Categorie-strategie. Categorieën worden niet automatisch aangemaakt of ingepland: je controleert daar eerst de SEO-, GEO- en hiërarchievelden en maakt daarna een hoofdcategorie, subcategorie of volledige hiërarchie aan."), p("De echte voortgang", "h2"), p("De knop Nu maken toont servergestuurde checkpoints: onderzoek, tekst genereren, tekst nakijken, afbeeldingen voorbereiden, afbeelding genereren, artikel samenstellen, concept opslaan, SEO en metadata en afronden. Het percentage hoort bij een feitelijk voltooid checkpoint; het is geen geschatte laadanimatie. Het kruisje naast de knop vraagt een veilige annulering aan. Publion stopt dan bij het eerstvolgende veilige servermoment en laat het onderwerp in de wachtrij staan. Bij bulk genereren toont de status altijd de positie in de geselecteerde batch, bijvoorbeeld: Item 2 van 4 wordt verwerkt.")]
    story += [p("Kwaliteit van de artikeltekst", "h2"), bullet("Een volledig semantisch HTML-concept met directe antwoorden, h2/h3-koppen, korte alinea's en waar passend een lijst, tabel of stappenplan."), bullet("Een complete generatie in plaats van aan elkaar geplakte vervolgteksten. Dit beperkt herhalingen en ongesloten lijsten."), bullet("Lokale duplicate-check op titel, inhoud en focus-keyword voordat een nieuw WordPress-concept wordt aangemaakt."), bullet("Bij ingeschakelde Rank Math-integratie maakt Publion een keyword-led SEO-titel en meta description, een korte URL en een natuurlijke focus-keyword in de intro, inhoud, een kop en de eerste relevante afbeelding. De generator vraagt dan circa 2.500 tot 2.800 woorden om de volledige Rank Math-lengtecontrole voor te bereiden."), bullet("Vóór opslag controleert Publion woordenaantal, keyworddichtheid van 1 tot 1,5 procent, intro, kop, korte alinea's en de SEO-titel. Bij een harde afwijking vraagt Publion één feitelijke herstelronde; blijft die afwijken, dan wordt een eventuele publicatie veilig omgezet naar Concept."), bullet("Rank Math's inhoudsopgaveblok wordt toegevoegd wanneer Rank Math actief is. De generator maakt vijf inhoudsafbeeldingen en één uitgelichte afbeelding; korte alinea's en minstens vier media-items bereiden de leesbaarheidstests voor."), bullet("In de WordPress-editor toont elk Publion-artikel een controlepaneel met woordenaantal, keyworddichtheid, geslaagde harde checks en redactionele aandachtspunten. Daarna laat Publion Rank Math zijn eigen analyse opnieuw uitvoeren. De score zelf komt uitsluitend van Rank Math; Publion simuleert of bewaart geen score."), bullet("Alleen relevante, verifieerbare links. Voeg in Postcreatie-instellingen minstens één gecontroleerde HTTPS-bron-URL toe om per artikel één externe bron te waarborgen; Publion verzint nooit een URL."), bullet("Live brononderzoek is optioneel: OpenAI web search levert uitsluitend daadwerkelijk gevonden HTTPS-bronnen. Kies model, 1 tot 5 bronnen, onderzoeksdiepte, live toegang, domeinbeleid en foutgedrag in de instellingen."), bullet("Als de klikbare bronnenlijst aan staat, plaatst Publion alleen werkelijk teruggegeven webbronnen onder het artikel. Onderzoek dat verplicht is ingesteld stopt de generatie veilig wanneer geen bruikbare bron terugkomt."), bullet("Een groen of zelfs 100/100-contentresultaat is geen garantie op een positie: inhoudelijke juistheid, concurrentie, autoriteit en technische SEO blijven bepalend.")]
